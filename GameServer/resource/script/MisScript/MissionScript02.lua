...
-------------------------------------------------海盗语言
	...
	MisNeed(MIS_NEED_DESP, "Follow Jack's intruction and look for <yMermaid Queen> at (2822, 1970) to obtain the <rMermaid Carcass>. Return to Jack after that.")
...
----------------------------------------------------为达赫解梦
	...
	MisBeginTalk( "<t>I give divinations only when my conditions are met. I'm making the most powerful Crystal Ball ever to be depicted in the legends, but I'm still lacking of 2 <yAzure Crystals>that can be found on <bFeral Blood Polliwog> at  (2550, 400) in Ascaron, and 3 <yPerfect Crystals> that can be found on <bHorrific Cursed Corpse> at (360, 1340) in Ascaron. You wouldn't reject me now, would you?" )------------++++++
	MisBeginCondition(NoRecord, 399)
